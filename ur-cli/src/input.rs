        ...
        let action = map_key(
            ...
            &crate::app::Screen::DiceOff {
                state: crate::app::DiceOffState {
                    p1_frames: 0,
                    p2_frames: 0,
                    p1_final: ur_core::dice::Dice::new(2).unwrap(),
                    p2_final: ur_core::dice::Dice::new(1).unwrap(),
                    p1_display: ur_core::dice::Dice::new(0).unwrap(),
                    p2_display: ur_core::dice::Dice::new(0).unwrap(),
                    winner: None,
                    acknowledged: false,
                },
            },
